...
function getScoreMessage(totalScore) {
  ...
  if (totalScore <= 9)
    return "Better than that 5-point crap, but you are not good at this.";
  if (totalScore <= 11)
    return "Very weak, but you're trying. That's worth something they say.";
  ...
  if (totalScore <= 23)
    return "Now you're pushing it, pally. Are you stashing tiles?";
  if (totalScore <= 25)
  ...
  if (totalScore <= 27)
    return "Maybe someone needs to teach you a little lesson, essay! We don't deal too well with cheaters around here. We are the BEST!! You were warned and now it's too late!";
  if (totalScore <= 29)
    return "You're dead to me, fuckface. You're ruined around here.";
  if (totalScore <= 30)
    return "You will be reported if you don't fuck off right this moment!";
