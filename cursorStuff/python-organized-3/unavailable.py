my_list = {
    ...
    'BULLY',
    'BULKY', 'BUNCH', 'BUNNY', 'BURLY', 'BURNT', 'BURST', 'BUTTE', 'BUYER', 'BYLAW', 'CABLE', 
    'CACAO', 'CACHE', 'CACTI',
    ...
    'COMMA', 'CONCH',
    'CONDO', 'CONIC', 'COPSE', 'CORAL', 'CORER', 'CORNY', 'COUCH', 'COULD', 'COUNT', 'COURT', 
    'COVEN', 
    'COVER',
    ...
    'CYBER', 'CYCLE', 'CYNIC',
    'DADDY', 'DAISY', 'DALLY', 'DANCE', 'DANDY', 'DATUM', 'DAUNT', 'DEALT', 'DEATH', 'DEBIT', 
    'DEBUG',
    ...
    'FORGE',
    'FORGO', 'FORTE', 'FORTH', 'FORTH', 'FORTY', 'FORUM', 'FOUND', 'FOYER', 'FRAIL', 'FRAME', 
    'FRANK',
